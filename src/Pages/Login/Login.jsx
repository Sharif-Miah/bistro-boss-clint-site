        ...
        <div className="card-body w-1/2 mx-auto">
          ...
          <form onSubmit={handleLogin}>
            <div>
              ...
              <div>
                <button onClick={handleValidCaptcha}  className="btn btn-xs w-80 mt-4 bg-orange-300 hover:bg-orange-400 font-bold uppercase">Validet</button>
              </div>
              <button disabled={disable} className="btn bg-orange-300 hover:bg-orange-400 text-white input-bordered  w-full max-w-xs mt-3">
                Register
              </button>
            </div>
          </form>
